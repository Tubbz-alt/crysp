...
public:
    ...
    inline constexpr rune torune() const noexcept {
        return unmake(val());
    }

    inline constexpr Rune toRune() const noexcept {
        return Rune{unmake(val())};
    }
